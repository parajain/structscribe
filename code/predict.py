...
def predict(s, model):
    ...
    ftemp = codecs.open('temp_seq2seq_pred.txt', 'w', "utf-8")
    ftemp.write(s.strip()+'\n')
    ftemp.close()
...
if __name__ == "__main__":
    print(predict('GPE locator GPE IS PREP', '/data1/data1/Anirban/structure2text/model_softmax_1_acc_84.10_ppl_2.13_e1.pt'))
